 ...
 * @version 1.0.0
 */
public class Flink_Project_SideOutPut {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> outputStreamOperator = wss
                ...
                .sideOutputLateData(new OutputTag<WaterSensor>("side-1") {
                })
        ...
        outputStreamOperator.getSideOutput(new OutputTag<WaterSensor>("side-1"){}).print("侧输出流：");
